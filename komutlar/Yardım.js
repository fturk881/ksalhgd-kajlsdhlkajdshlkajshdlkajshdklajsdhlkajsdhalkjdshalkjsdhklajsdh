...
exports.run = async(client, message, args) => {
        ...
        **__Komut Listesi__**
        ...
        [Support Server](https://discord.com/invite/AZdzRJPSye8) | [Add Bot](https://discord.com/api/oauth2/authorize?client_id=793738036084211725&permissions=8&scope=bot)`)
