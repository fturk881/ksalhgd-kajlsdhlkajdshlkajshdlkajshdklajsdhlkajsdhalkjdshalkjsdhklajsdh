...
let AddField;
if (ayarlar.geliştiriciler.includes(User.id)) AddField = `${User.bot ? `${User.tag} \\🤖 && ${client.emojis.cache.get('809515364269817936')}

\\🤖 » Discord Botu
${client.emojis.cache.get('809515364269817936')} » ${client.user.username} Geliştiricisi` : `${User.tag} ${client.emojis.cache.get('809515364269817936')}

${client.emojis.cache.get('809515364269817936')} » ${client.user.username} Geliştiricisi`}`
