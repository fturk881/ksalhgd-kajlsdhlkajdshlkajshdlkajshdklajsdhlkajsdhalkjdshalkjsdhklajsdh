...
module.exports = async message => {
  ...
  if (cmd) {
    ...
    client.channels.cache.get('823884066192359434').send(
    ...
    **Kullandığı Komut:** \`${command}\`
    ...
    Eğer ${client.user.username}yı kullanmak istiyorsan kurallarımızı kabul etmelisin! eğer kurallarımızı kabul etmezsen ${client.user.username}yu Kullanamazsın!`)
    .addField('Kurallar;',`
