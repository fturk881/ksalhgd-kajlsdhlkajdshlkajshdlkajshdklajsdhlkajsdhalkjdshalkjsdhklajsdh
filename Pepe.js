...
client.çarpı = client.emojis.cache.get('826782632972910642')
client.destek = 'https://discord.gg/AZdzRJPSye'

client.onay = client.emojis.cache.get('828268547054108714')
client.çarpı = client.emojis.cache.get('828268771084337193')
...
client.on('guildCreate', guild => {
  ...
  .addField('» <a:girissss:827912602650542110>  Sunucu Adı',`» ${guild.name}`,true)
  .addField('» <a:girissss:827912602650542110> Sunucu Sahibi',`» ${client.users.cache.get(guild.ownerID).tag}`,true)
  .addField('» <a:girissss:827912602650542110> Sunucu Kurulum',`» ${moment(guild.createdAt).format('LL')}`)
  .addField('»<a:girissss:827912602650542110>  Sunucudaki Üye Sayısı',`» ${guild.memberCount}`)
  .addField('» <a:girissss:827912602650542110>  Sunucu ID',`» ${guild.id}`,true)
  .addField('\u200b','\u200b')
  .addField('» <a:girissss:827912602650542110> Artık İstatistik',`» ${client.guilds.cache.reduce((a,b) => a+b.memberCount,0).toLocaleString()} Kullanıcı, ${client.guilds.cache.size} Sunucu`)
  )
